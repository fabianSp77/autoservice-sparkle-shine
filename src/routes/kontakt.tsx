  ...
  head: () => ({
    meta: [
      { title: "Kontakt — Autoservice Beuerberg | 24/7 telefonisch erreichbar" },
      {
        name: "description",
        content:
          "Telefonisch rund um die Uhr erreichbar: 08179 929244. Persönlich Mo–Do 07:30–12 und 13–18 Uhr, Fr 07:30–12 Uhr, außerhalb über unseren Telefonassistenten. Oder schreiben Sie uns eine Nachricht.",
      },
